...
import (
	...
	app "github.com/leandro-koller-bft/hexarch/app"
)
...
func (m *MockIProductService) Create(name string, price float64) (app.IProduct, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockIProductReader) Get(id string) (app.IProduct, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(app.IProduct)
	ret1, _ := ret[1].(error)
...
func (m *MockIProductWriter) Save(product app.IProduct) (app.IProduct, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockIProductPersistence) Get(id string) (app.IProduct, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(app.IProduct)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockIProductPersistence) Save(product app.IProduct) (app.IProduct, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(app.IProduct)
	ret1, _ := ret[1].(error)
